                ...
                <form className="">
                    ...
                    <div className="flex items-start mb-6">
                        <div className="flex items-center h-5">
                            <p className="text-white">Already have an account? <a href="#" className="text-accent underline">Log In</a></p>
                        </div>
                    </div>
                    <button type="submit" className="text-white text-xl bg-primary rounded-xl w-full text-center p-5">Sign Up</button>
            </form>
        </div>
    </div>
    )
